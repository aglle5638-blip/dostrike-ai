...
const STEPS = [
  {
    icon: "🎯",
    title: "好みの女優をスワイプして教える（10枚）",
    desc: "初回ログイン後、女優の写真が1枚ずつ表示されます。好みの顔なら右スワイプまたは❤️ボタン、そうでなければ左スワイプまたは✕ボタン。たった10枚に答えるだけで、AIがあなたの好みタイプを自動判定します。",
    tip: "スマホでは指でスワイプ、PCではボタンまたはキーボードの矢印キーで操作できます。後から「いいね」「チェンジ」のフィードバックでさらに精度を上げられます。",
  },
  {
    icon: "⚡",
    title: "AIが好みの女優に近い作品をピックアップ",
    desc: "スワイプ完了後、好みと判定された女優に近いタイプが出演する作品をFANZAのデータベースから自動抽出。マッチ度の高い順に6本の作品が即座に表示されます。",
